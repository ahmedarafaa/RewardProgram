...
public class AdminAddShopOwnerRequestValidator : AbstractValidator<AdminAddShopOwnerRequest>
{
    private readonly string[] _allowedImageExtensions = { ".jpg", ".jpeg", ".png" };
    private const long MaxImageSize = 5 * 1024 * 1024; // 5MB

    public AdminAddShopOwnerRequestValidator(IStringLocalizer<ValidationMessages> L)
    {
