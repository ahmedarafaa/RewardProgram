...
public class AdminAddZoneManagerRequestValidator : AbstractValidator<AdminAddZoneManagerRequest>
{
    public AdminAddZoneManagerRequestValidator(IStringLocalizer<ValidationMessages> L)
    {
        RuleFor(x => x.Name)
